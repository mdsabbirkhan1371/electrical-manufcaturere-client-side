...
const Blogs = () => {
    return (
        <div className='container py-5'>
            <div>
                <h4>Question(1): How will you improve the performance of a React Application?</h4>
            ...
            <div>
                <h4>Question(2):  What are the different ways to manage a state in a React application?</h4>
            ...
            <div>
                <h4>Question(3):  How does prototypical inheritance work?</h4>
            ...
            <div>
                <h4>Question(4):  Why you do not set the state directly in React. For example, if you have const [products, setProducts] = useState([]). Why you do not set products = [...] instead, you use the setProducts</h4>
            ...
            <div>
                <h4>Question(5): You have an array of products. Each product has a name, price, description, etc. How will you implement a search to find products by name?</h4>
                <p>Answer: </p>
            ...
            <div>
                <h4>Question(6): What is a unit test? Why should write unit tests?</h4>
                <p>Answer: </p>
